...
// POST /coins/request — admin submits a top-up request (body: { amount })
...
// POST /coins/requests/:id/approve — super admin approves and credits coins
...
// POST /coins/requests/:id/reject — super admin rejects
